...
/*updateLEDs() determines which LED has the most button presses
it does this by checking which count has the maximum count
led with the most count is turned on */
void updateLEDs(){
    led1 = 0;
	led2 = 0;
	led3 = 0;
